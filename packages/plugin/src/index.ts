...
function load_fonts() {
GlobalFonts.registerFromPath(`${Version.Plugin_Path}/resources/fonts/NotoColorEmoji-Regular.woff2`)
GlobalFonts.registerFromPath(`${Version.Plugin_Path}/resources/fonts/DouyinSansBold.woff2`)
}